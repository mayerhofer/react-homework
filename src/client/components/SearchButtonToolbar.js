                ...
                <Grid fluid={true}>
                    <Row className="show-grid">
                        ...
                        <Col xs={12} sm={2} md={1} lg={1}>
                            <Button bsStyle={this.props.searchFilter === filters.SEARCH_BY_TITLE ? 'danger' : 'default'} onClick={() => this.props.setFilter(filters.SEARCH_BY_TITLE)}>{pageTexts.CAPTION_BY_TITLE_BUTTON}</Button>
                            <Button bsStyle={this.props.searchFilter === filters.SEARCH_BY_GENRE ? 'danger' : 'default'} onClick={() => this.props.setFilter(filters.SEARCH_BY_GENRE)}>{pageTexts.CAPTION_BY_GENRE_BUTTON}</Button>
                        </Col>
